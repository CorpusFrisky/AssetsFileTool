...
const char *ClassDatabaseFileString::GetString(ClassDatabaseFile *pFile)
{
	if (!fromStringTable)
		return str.string;
...
QWORD ClassDatabaseFileString::Read(IAssetsReader *pReader, QWORD filePos)
{
	fromStringTable = true;
	pReader->Read(filePos, 4, &str.stringTableOffset);
	return (filePos+4);
}
QWORD ClassDatabaseFileString::Write(IAssetsWriter *pWriter, QWORD filePos)
{
	pWriter->Write(filePos, 4, &str.stringTableOffset);
	return (filePos+4);
}

QWORD ClassDatabaseTypeField::Read(IAssetsReader *pReader, QWORD filePos, int version)
{
...
QWORD ClassDatabaseTypeField::Write(IAssetsWriter *pWriter, QWORD filePos, int version)
{
...
ClassDatabaseType::ClassDatabaseType(const ClassDatabaseType& other)
{
...
bool ClassDatabaseType::FromTemplateField(int classId, int baseClass, AssetTypeTemplateField *pTemplateBase)
{
...
QWORD ClassDatabaseType::Read(IAssetsReader *pReader, QWORD filePos, int version, uint8_t flags)
{
	uint32_t fieldCount;
...
QWORD ClassDatabaseType::Write(IAssetsWriter *pWriter, QWORD filePos, int version, uint8_t flags)
{
...
Hash128 ClassDatabaseType::MakeTypeHash(ClassDatabaseFile *pDatabaseFile)
{
	Hash128 ret = {};
	HCRYPTPROV hContext;
...
Hash128 MakeScriptID(const char *scriptName, const char *scriptNamespace, const char *scriptAssembly)
{
	Hash128 ret = {};
	HCRYPTPROV hContext;
	if (!CryptAcquireContext(&hContext, NULL, NULL, PROV_RSA_FULL, CRYPT_VERIFYCONTEXT))
...
QWORD ClassDatabaseFileHeader::Read(IAssetsReader *pReader, QWORD filePos)
{
...
QWORD ClassDatabaseFileHeader::Write(IAssetsWriter *pWriter, QWORD filePos)
{
...
QWORD ClassDatabaseFile::Read(IAssetsReader *pReader, QWORD filePos)
{
	valid = false;
...
bool ClassDatabaseFile::Read(IAssetsReader *pReader)
{
	Read(pReader, 0ULL);
	return valid;
}
...
QWORD ClassDatabaseFile::Write(IAssetsWriter *pWriter, QWORD filePos, int optimizeStringTable, uint32_t compress, bool writeStringTable)
{
...
bool ClassDatabaseFile::IsValid()
{
	return valid;
}

bool ClassDatabaseFile::InsertFrom(ClassDatabaseFile *pOther, ClassDatabaseType *pType)
{
...
ClassDatabaseFile &ClassDatabaseFile::operator=(const ClassDatabaseFile& other)
{
	valid = other.valid;
...
ClassDatabaseFile::ClassDatabaseFile(const ClassDatabaseFile& other)
{
	(*this) = other;
}
ClassDatabaseFile::ClassDatabaseFile(ClassDatabaseFile&& other)
{
	valid = other.valid;
...
void FreeClassDatabase_Dummy(ClassDatabaseFile *pFile)
{}

QWORD ClassDatabasePackageHeader::Read(IAssetsReader *pReader, QWORD filePos)
{
...
QWORD ClassDatabasePackageHeader::Write(IAssetsWriter *pWriter, QWORD filePos)
{
...
void ClassDatabasePackage::Clear()
{
	if (files)
	{
...
bool ClassDatabasePackage::Read(IAssetsReader *pReader)
{
	Clear();
	valid = false;
...
QWORD ClassDatabasePackage::Write(IAssetsWriter *pWriter, QWORD filePos, int optimizeStringTable, uint32_t compress)
{
...
bool ClassDatabasePackage::RemoveFile(uint32_t index)
{
...
bool ClassDatabasePackage::ImportFile(IAssetsReader *pReader)
{
	ClassDatabaseFile **newFiles = new PClassDatabaseFile[(header.fileCount + 1)];
...
bool ClassDatabasePackage::IsValid()
{
	return valid;
}
	
ClassDatabasePackage::~ClassDatabasePackage()
{
	Clear();
}