...
int AssetExportTask::execute()
{
	...
	for (size_t i = 0; i < assets.size(); ++i)
	{
		...
		try {
			bool result = exportAsset(assets[i], exportPath);
...
void AssetExportTask::onCompletion(const std::string& outputPath)
{}
...
{}
bool AssetExportRawTask::exportAsset(AssetUtilDesc& desc, std::string path)
{
...
{}
bool AssetExportDumpTask::exportAsset(AssetUtilDesc& desc, std::string path)
{
