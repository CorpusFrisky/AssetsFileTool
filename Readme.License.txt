I've barely looked in licensing and the legality of what I'm doing here, but I hope it's enough to say that I'm not trying to profit in any
way and hope I'm not upsetting anybody with what I'm doing here.  I'm just trying to port some UABE code over into a simple project that
decouples the logic from the UI so it can be used via command line.  Any request to cease and desist will be complied with immediately.

For now, I think I at least need to include the license file from UABE in it's entirely.  So here it is.
